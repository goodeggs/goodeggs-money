...
describe('Cents', function () {
  ...
  describe('.round', function () {
    ...
    return it('throws if given a negative number', () => expect(() => round(-0.1)).to.throw());
  });
  ...
  describe('.isValid', function () {
    ...
    return it('is invalid for float', () => expect(isValid(1.5)).to.be.false);
  });
  ...
  describe('.isValidDollars', function () {
    ...
    return it('is invalid for a non-dollar string', () =>
      expect(isValidDollars('33.444')).to.be.false);
  });
  ...
  describe('.greaterThan', function () {
    ...
    return it('should allow strict mode false', function () {
      ...
      return expect(new Cents(5).greaterThan('4', {strict: false})).to.be.true;
    });
  });
  ...
  describe('.greaterThanOrEqual', function () {
    ...
    return it('should allow strict mode false', function () {
      ...
      return expect(new Cents(5).greaterThanOrEqual('4', {strict: false})).to.be.true;
    });
  });
  ...
  describe('.lessThanOrEqual', function () {
    ...
    return it('should allow strict mode false', function () {
      ...
      return expect(new Cents(5).lessThanOrEqual('10', {strict: false})).to.be.true;
    });
  });
  ...
  describe('arithmetic', function () {
    describe('plus', function () {
      ...
      return it('should allow strict mode true', function () {
        ...
        return expect(() => new Cents(5).plus('5', {strict: true})).to.throw();
      });
    });
    ...
    describe('minus', function () {
      ...
      return it('should allow strict mode true', function () {
        ...
        return expect(() => new Cents(5).minus('5', {strict: true})).to.throw();
      });
    });
    ...
    describe('times', function () {
      ...
      return it('should allow transform', function () {
        ...
        return expect(cents.times(0.5, {transform: 'floor'})).to.have.property('value', 2);
      });
    });
    ...
    describe('dividedBy', function () {
      ...
      return it('should allow transform', function () {
        ...
        return expect(cents.dividedBy(50, {transform: 'ceil'})).to.have.property('value', 1);
      });
    });
